...
2.  Brunel, N. (2000). Dynamics of sparsely connected networks of excitatory and inhibitory spiking neurons. *Journal of Computational Neuroscience, 8*(3), 183–208. https://doi.org/10.1023/a:1008925309027 *(Seminal theoretical work analyzing the dynamics of randomly connected E/I spiking networks, highly relevant to the second example and network dynamics in general.)*
3.  Destexhe, A., Mainen, Z. F., & Sejnowski, T. J. (1994). Synthesis of models for synaptic currents, membrane potential fluctuations and morphological types of systems of neurons. *Journal of Computational Neuroscience, 1*(3), 195–230. https://doi.org/10.1007/BF00961875 *(Provides detailed background on modeling synaptic currents and conductances, underpinning the conductance-based models discussed.)*
4.  Gewaltig, M.-O., & Diesmann, M. (2007). NEST (Neural Simulation Tool). *Scholarpedia, 2*(4), 1430. https://doi.org/10.4249/scholarpedia.1430 *(Describes another major neural simulator, NEST, providing context on the landscape of simulation tools and different approaches to network construction.)*
5.  Hertz, J., Krogh, A., & Palmer, R. G. (1991). *Introduction to the theory of neural computation*. Addison-Wesley. *(A foundational textbook covering various aspects of neural networks, including basic network structures and dynamics, providing theoretical background.)*
6.  Litwin-Kumar, A., & Doiron, B. (2012). Slow dynamics and high variability in balanced cortical networks with clustered connectivity. *Nature Neuroscience, 15*(11), 1498–1505. https://doi.org/10.1038/nn.3220 *(Explores dynamics in more complex E/I networks with non-random structure (clustering), relevant for understanding how topology beyond simple random affects activity.)*
7.  Morrison, A., Aertsen, A., & Diesmann, M. (2007). Spike-timing-dependent plasticity in balanced random networks. *Neural Computation, 19*(6), 1437-1467. https://doi.org/10.1162/neco.2007.19.6.1437 *(Illustrates constructing and simulating balanced random networks, often the target regime for models in this chapter, albeit focused on plasticity.)*
8.  Potjans, T. C., & Diesmann, M. (2014). The cell-type specific cortical microcircuit: Relating structure and activity in a full-scale spiking network model. *Cerebral Cortex, 24*(3), 785–806. https://doi.org/10.1093/cercor/bhs358 *(A landmark paper demonstrating large-scale simulation of a cortical microcircuit with detailed connectivity rules, showcasing complex network construction far beyond this chapter's examples.)*
9.  Stimberg, M., Brette, R., & Goodman, D. F. M. (2019). Brian 2, an intuitive and efficient neural simulator. *eLife, 8*, e47314. https://doi.org/10.7554/eLife.47314 *(The primary reference for Brian2, essential for understanding the tool used for implementation in this chapter and its capabilities for network building.)*
10. van Vreeswijk, C., & Sompolinsky, H. (1996). Chaos in neuronal networks with balanced excitatory and inhibitory activity. *Science, 274*(5293), 1724–1726. https://doi.org/10.1126/science.274.5293.1724 *(Influential theoretical work on the complex dynamics (asynchronous, chaotic) emerging in balanced E/I networks, often studied via simulation methods introduced here.)*
